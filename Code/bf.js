require([
...
], function(Map, MapView,FeatureLayer,BasemapGallery,Editor,Search,Expand,watchUtils,Graphic,Query,QueryTask,Track,Home,RouteTask,RouteParameters,FeatureSet,ActionButton,Point,Polyline,Popup,Legend,GraphicsLayer) {
  ...
  const popupTemplate = {
    ...
    var isRouteShowed = false,isDirectionsShowed = false,isFieldOptionsShowed = false,isFieldsFiltered = false,isInfoShowed = false;
    ...
    function addButtons(){
        ...
        img.src = "https://icon2.kisspng.com/20180328/xhq/kisspng-paper-google-map-maker-computer-icons-world-map-location-icon-5abbd6d8dee0b3.1544670315222596729129.jpg";
        
        btn_showLocation.appendChild(img);
        btn_showLocation.style.backgroundColor = "white";
        btn_showLocation.style.padding = "5px";
        btn_showLocation.style.opacity = 0.9;
        ...
        btn_closeLocation.style.backgroundColor = "#fff";
        btn_closeLocation.style.padding = "5px";
        btn_closeLocation.style.opacity = 0.9;
        ...
        //img3.src = "http://www.soidergi.com/wp-content/uploads/pn/thumb-png-outline-of-basketball-canestro-clip-art-basketball.jpg";
        //img3.src = "https://www.freepngimg.com/thumb/basketball/11-black-basketball-ball-png-image-thumb.png";
        img3.src = "https://www.stickpng.com/assets/thumbs/588884fcbc2fc2ef3a186094.png";
        btn_findClosestField.appendChild(img3);
        btn_findClosestField.style.backgroundColor = "#fff";
        btn_findClosestField.style.padding = "5px";
        btn_findClosestField.style.opacity = 0.9;
        ...
        btn_findFieldIn.style.backgroundColor = "#fff";
        btn_findFieldIn.style.padding = "5px";
        btn_findFieldIn.style.opacity = 0.9;
        

        var btn_infoButton = document.createElement('button');
        btn_infoButton.title = "info"
        btn_infoButton.id = "customButton1";
        var img5 = document.createElement("img");
        img5.width = 18;
        img5.height = 18;
        img5.src = "https://cdn3.iconfinder.com/data/icons/media-icons-23/100/info2-128.png";
        btn_infoButton.appendChild(img5);
        ...
        var infoImg1 = document.createElement("img");
        infoImg1.src = "https://icon2.kisspng.com/20180328/xhq/kisspng-paper-google-map-maker-computer-icons-world-map-location-icon-5abbd6d8dee0b3.1544670315222596729129.jpg";
        infoImg1.width = 18;
        infoImg1.height = 18;
        infoImg1.id = "infoImg1";
        span2.appendChild(infoImg1);

        var label_infoImg1 = document.createElement('label');
        label_infoImg1.htmlFor = "infoImg1";
        label_infoImg1.appendChild(document.createTextNode("  --> Show My Location Button:  By clicking this button you can see your location on the map."));
        span2.appendChild(label_infoImg1);
        span2.appendChild(document.createElement("br"));
        span2.appendChild(document.createElement("br"));

        var infoImg2 = document.createElement("img");
        infoImg2.src = "https://www.stickpng.com/assets/thumbs/588884fcbc2fc2ef3a186094.png";
        infoImg2.width = 18;
        infoImg2.height = 18;
        infoImg2.id = "infoImg2";
        span2.appendChild(infoImg2);
        
        var label_infoImg2 = document.createElement('label');
        label_infoImg2.htmlFor = "infoImg2";
        label_infoImg2.appendChild(document.createTextNode("  --> Find Closest Basketball Field:  By clicking this button you can see the closest field around you."));
        span2.appendChild(label_infoImg2);
        span2.appendChild(document.createElement("br"));
        span2.appendChild(document.createElement("br"));

        var infoImg3 = document.createElement("img");
        infoImg3.src = "https://img.icons8.com/cotton/2x/search.png";
        infoImg3.width = 18;
        infoImg3.height = 18;
        infoImg3.id = "infoImg3";
        span2.appendChild(infoImg3);

        var label_infoImg3 = document.createElement('label');
        label_infoImg3.htmlFor = "infoImg3";
        label_infoImg3.appendChild(document.createTextNode("  --> Find Basketball Fields In Region:  See the regions and filter Basketball Fields by their regions."));
        span2.appendChild(label_infoImg3);
        span2.appendChild(document.createElement("br"));
        span2.appendChild(document.createElement("br"));


        var infoImg4 = document.createElement("img");
        infoImg4.src = "https://github.com/Esri/arcgis-js-api/blob/master/themes/calcite/icons/images/png/Basemap.png?raw=true";
        infoImg4.width = 16;
        infoImg4.height = 16;
        infoImg4.id = "infoImg4";
        span2.appendChild(infoImg4);

        var label_infoImg4 = document.createElement('label');
        label_infoImg4.htmlFor = "infoImg4";
        label_infoImg4.appendChild(document.createTextNode("  --> Basemap Toggle:  Change the basemap of the application"));
        span2.appendChild(label_infoImg4);
        span2.appendChild(document.createElement("br"));
        span2.appendChild(document.createElement("br"));
        

        var infoImg5 = document.createElement("img");
        infoImg5.src = "https://github.com/Esri/arcgis-js-api/blob/master/themes/calcite/icons/images/png/edit.png?raw=true";
        infoImg5.width = 16;
        infoImg5.height = 16;
        infoImg5.id = "infoImg5";
        span2.appendChild(infoImg5);

        var label_infoImg5 = document.createElement('label');
        label_infoImg5.htmlFor = "infoImg5";
        label_infoImg5.appendChild(document.createTextNode("  --> Basketball Field Editor:  Choose the field that you want to edit or add new one"));
        span2.appendChild(label_infoImg5);
        span2.appendChild(document.createElement("br"));
        ...
        btn_showSelectedLayers.style.backgroundColor = "gray";
        btn_showSelectedLayers.style.padding = "3px";
        btn_showSelectedLayers.style.borderRadius = "8px";
        ...
        view.ui.add(btn_findClosestField,"top-right");
        view.ui.add(btn_showLocation, 'top-right');
        view.ui.add(btn_infoButton,"bottom-right");
        ...
        btn_showLocation.addEventListener('click', () => {
            ...
            if(!isLocationShowed){
              ...
              view.ui.add(btn_closeLocation,"top-right");
            }
        });
        ...
        btn_infoButton.addEventListener("click",()=>{
        ...
        btn_findFieldIn.addEventListener('click',()=>{
          ...
          if(!isFieldOptionsShowed){
            ...
            var filteredFields = new GraphicsLayer();
            var filteredFieldsPolygon = new GraphicsLayer();
            //filteredFields.id = "filteredFields";
            
            //filteredFieldsPolygon.opacity = 0.5;
            map.add(filteredFields);
            map.add(filteredFieldsPolygon);
            //filteredFieldsPolygon.id = "filteredFieldsPolygon";

            btn_showSelectedLayers.addEventListener('click', () => {
              filteredFields.removeAll();
              var checkboxLength = (span1.childNodes.length-2)/3;
              var checkboxIndexes = [];
              
              for(var i=0;i<checkboxLength;i++){
                if(span1.childNodes[3*i].checked){
                  
                  checkboxIndexes.push(span1.childNodes[3*i].id);
                }
              }
              
              var features = [];
              
              for(var j=0;j<checkboxIndexes.length;j++){

                
                var filteredFieldQuery = new Query();
                
                filteredFieldQuery.where = "NEIGHBORHOOD = '"+checkboxIndexes[j]+"'";
                filteredFieldQuery.outFields = ["*"];
                filteredFieldQuery.returnGeometry = true;
      
                var queryTask = new QueryTask({

                  url:"http://services7.arcgis.com/bNLjDotbYJVS3u6n/arcgis/rest/services/Turkiye_Basketbol_Sahalari/FeatureServer/0",
                });

                queryTask.execute(filteredFieldQuery).then(function(result){

                  result.features.forEach(function(field){

                    features.push(field.geometry);
                    var tempPoint = {
                      type: 'point',
                      latitude: field.geometry.latitude,
                      longitude: field.geometry.longitude
                    };
                    var pointSymbol = {
                    ...
                    var tempGrap = new Graphic({
                      geometry: tempPoint,
                      symbol: pointSymbol
                    });

                    filteredFields.add(tempGrap);
                    
                    var ringsArray = [];
                    
                    for(var k = 0;k<features.length;k++){

                      var coordinates = [features[k].latitude,features[k].longitude];
                    ...
                    filteredFieldsPolygon.removeAll();
                    ...
                    filteredFieldsPolygon.add(polygonGraphic);
                    //console.log('2');
                    //console.log(filteredFieldsPolygon);
                    //console.log(filteredFieldsPolygon.id); 
                  });
